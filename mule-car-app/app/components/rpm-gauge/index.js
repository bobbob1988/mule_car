...
import lights from '../../../resources/images/lights.svg';
import seatBelt from '../../../resources/images/seat-belt.svg';
import rearWindowDefrost from '../../../resources/images/rear-window-defrost.svg';
...
export default class RpmGauge extends Component {  
  ...
  generate() {
    ...
    const svgHeight = 550; //parseInt(svg.style("height"));
  ...
  render() {
    return (
      <div className="rpm-gauge center-block"></div>
      )
  }
}
